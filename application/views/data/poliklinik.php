                ...
                <table class="table table-hover table-bordered">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Klinik</th>
                      <th>Jumlah Dokter Klinik</th>
                      <th class="text-center">Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $no=1; foreach($poliklinik as $data): ?>
                    <tr>
                      <td><?=$no ?></td>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title">Edit Data Klinik</h4>
                          </div>
                          <form action="<?=site_url()?>/Welcome/crud/edit/poliklinik/<?=$data['id_klinik']?>" method="POST" role="form">
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label>Nama Klinik</label>
                                  <input type="text" maxlength="20" class="form-control" name="nama_klinik" value="<?=$data['nama_klinik']?>">
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="modal fade" id="hapus<?=$no?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Hapus Data Klinik</h4>
                          </div>
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-md-12">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <a href="<?=site_url()?>/Welcome/crud/delete/poliklinik/<?=$data['id_klinik']?>" class="btn btn-danger">Hapus Data</a>
                          </div>
                        </div>
                      </div>
                    </div>
...
<div class="modal fade" id="create_new">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Tambah Data Klinik</h4>
      </div>
      <form action="<?=site_url()?>/Welcome/crud/create_new/poliklinik" method="POST" role="form">
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label>Nama Klinik</label>
              <input type="text" maxlength="20" class="form-control" name="nama_klinik">
            </div>
          </div>
        </div>
      </div>
